    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverTemplates", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LinkedAccountType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArticleComments_ArticleComments_QuotedCommentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_AspNetUsers_LastEditedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExplanationArticleId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProblemDrivers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProblemDrivers_Problems_ProblemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleComments_QuotedCommentId",
                table: "ArticleComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProblemDrivers_ProblemId",
                table: "ProblemDrivers",
                column: "ProblemId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Articles_Problems_ProblemId",
                table: "Articles",
                column: "ProblemId",
                principalTable: "Problems",
                principalColumn: "Id");
