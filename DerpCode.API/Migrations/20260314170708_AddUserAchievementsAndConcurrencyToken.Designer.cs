...
namespace DerpCode.API.Migrations
{
    ...
    [Migration("20260314170708_AddUserAchievementsAndConcurrencyToken")]
    partial class AddUserAchievementsAndConcurrencyToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DerpCode.API.Models.Entities.ExperienceEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DerpCode.API.Models.Entities.UserAchievement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DerpCode.API.Models.Entities.UserProblemProgress", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BestXp")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("FirstSubmitAtCurrentCycle")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("FirstXpAwardedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("LastAwardedCycleIndex")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("LastSolvedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("OpenedHintIndicesCurrentCycle")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<int>("SubmitAttemptsCurrentCycle")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UserProblemProgress");
                });

            modelBuilder.Entity("DerpCode.API.Models.Entities.UserProgress", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DerpCode.API.Models.Entities.UserProgress", b =>
                {
                    b.HasOne("DerpCode.API.Models.Entities.User", "User")
                        .WithOne("Progress")
                        .HasForeignKey("DerpCode.API.Models.Entities.UserProgress", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
