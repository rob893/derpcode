import { DriverTemplate, Language } from './models';

export const driverTemplates: DriverTemplate[] = [
  {
    id: '1',
...
public class Program
{
    ...
    {
        // parse input and extected output json objects and implement your test logic here
...
main();`,
    uiTemplate: `export function add(a, b) { // update the function signature to match your requirements
    // Your code here
}`
  },
  {
...
main();`,
    uiTemplate: `export function add(a: number, b: number): number { // update the function signature to match your requirements
    // Your code here
}`
  }
];
